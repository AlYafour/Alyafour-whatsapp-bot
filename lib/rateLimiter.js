...
const MEDIA_SEND_WINDOW_SECONDS = 5 * 60;
const MEDIA_SEND_MAX_ATTEMPTS = 40;

const checkMediaSendRateLimit = (key) =>
  checkRateLimit('media-send', key, {
    windowSeconds: MEDIA_SEND_WINDOW_SECONDS,
    maxAttempts: MEDIA_SEND_MAX_ATTEMPTS,
  });

module.exports = { checkLoginRateLimit, checkTemplateSendRateLimit, checkMediaSendRateLimit };
