...
async function sendAndLogMessage({ conversationId, waId, text, senderType, sentBy, resetUnread }) {
  ...
  const message = await recordOutboundMessage({ conversationId, waMessageId, senderType, text, sentBy, status });
